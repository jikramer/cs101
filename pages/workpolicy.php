			...
			<div id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="card-block">
							Each week you have the option to attend a two-hour closed lab session.  The labs are run by the course faculty and grutors (student graders/tutors).  
							They provide a great opportunity for you to practice with new material on some fun problems in a supervised setting. 
							Attendance at labs is not required, but we strongly encourage you to attend! Specifically, we incentivize the labs as follows:
							<ul>
								<li>								
									If you attend lab, <i>sign-in</i>, make a good-faith effort throughout, you will receive full credit on the lab problem(s) - which are always part of the 
									week's homework problems - even if you do not complete them fully or fully correctly 
								</li> 
								<li>
									You're welcome to complete the lab in your own time - not a terrible idea - but this is <i><b>not</b></i> required
								</li> 
								<li>
