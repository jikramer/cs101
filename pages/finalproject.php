...
<a name="top"></a>
  ...
  <img class="logo" src="./CS5Fall2015 - ProjectsPage_files/cs5_logo.png">
</div>
<p>
</p><p>
...
<a name="text"></a><h2><a name="Final_projects"></a> Final projects </h2>
<p>
<!-- <ul>
...
<!--
<h3><a name="Extra_credit_survey"></a><a name="Extra_credit_survey_"></a> Extra-credit survey! </h3>
<p />
We are collaborating with Pomona Unified school district to bring CS to their elementary and middle-school curriculum. To that end, we're asking Pomona Unified middle-school students a few affective questions about their CS experiences.
<p />
It would help the project significantly if you would be willing to take the survey, as well, as college-level CS is the point of traditional first exposure to the field. <i><b>Warning</b></i> The survey is written for an elementary/middle school audience (not by us, by folks who specialize in educational assessment), so it's very basic -- please set aside the level at which it's pitched!
<p />
So, for +10 points of extra credit, we invite you to take the SurveyMonkey survey at
<p />
...
</p><h3><a name="Final_project_submission"></a> Final-project submission </h3>
<p>
The <b><i>milestone</i></b> is due as part of <a href="https://www.cs.hmc.edu/twiki/bin/view/CS5/Homework12Gold" target="_top">hw12</a> </p><ul>
...
</p><h3><a name="Project_Options_and_Details"></a> Project Options and Details </h3>
<p>
</p><p>
<!--
For the final project, include all of your files as a <tt>zip</tt> archive and submit as one of these names: <ul>
...
We have three possible final project themes in CS5. All of the provide the chance to build a significant software application in Python - and all of them also provide opportunities for creative expansion of the basic themes... !
</p><p>
Here are the three project descriptions:
</p><p>
<!--
...
</p><h3><a name="Overview"></a> Overview </h3>
<p>
...
</p><h3><a name="Milestone_guidelines"></a><a name="Milestone_guidelines_"></a> Milestone guidelines... </h3>
<p>
</p><h5><a name="Milestone_requirements_for_the_t"></a> <font color="darkred">Milestone requirements</font> for the <tt>textid</tt> project </h5>
<p>
<b>Milestone methods</b>: </p><ul>
<li> <tt>readTextFromFile(self, filename)</tt>: should take in a filename (a string)       and should return all of the text in that file as a single, very large string
</li> <li> <tt>makeSentenceLengths(self, s)</tt>: should use the text in the input string <tt>s</tt> to create          the <tt>self.sentencelengths</tt> dictionary
</li> <li> <tt>printAllDictionaries(self)</tt>: should print out all five of <tt>self</tt>'s dictionaries in full - for testing and checking how they are working...
</li> <li> <tt>cleanString(self,s)</tt>: should take in a string <tt>s</tt> and return a string with no punctuation and no upper-case letters
...
Be sure to zip up the folder containing your Text ID project file (or files) and name it <tt>textid_milestone.zip</tt> -- then submit that in the right spot within hw#12!
</p><p>
<br>
</p><p>
</p><h5><a name="Milestone_requirements_for_the_P"></a> <font color="darkred">Milestone requirements</font> for the Picobot project </h5>
<p>
...
</p><h5><a name="Milestone_requirements_for_the_v"></a> <font color="darkred">Milestone requirements</font> for the vPython project </h5>
<p>
For the milestone, you should submit a version for which the following pieces are implemented and work: </p><ul>
<li> A text document called <code>milestone.txt</code> with your name and the name of your partner (if any), the project that you've chosen, and a brief description of your plans for your game. One paragraph will suffice for the description. Also, include a description of the objective of the game - <i><b>and how we should run it!</b></i>
</li> <li> In addition, your document should give instructions for playing the game as it currently operates, e.g. "Pressing the "s" key will do one thing, the mouse will allow the user to do another thing, etc."
