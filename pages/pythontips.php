...
<html>
	...
	<body>	
		...
		<ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item active">Python Tips</li>
		</ol>
				...
				<div class="card">
					...
					<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
						<div class="card-block">	
							If you get an error similar to the following: syntaxError: Non-ASCII character '\xc5' in file hw8pr3.py ...
							Then, add the following line <i><b>at the very top left of your Python file</b></i>: # coding: utf-8
							which tells Python to allow arbitrary unicode characters. 
						</div>
					</div>
				</div>
				<div class="card">
					...
					<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="card-block">
							It's a pain to leave python and re-run, especially because all of your previous commands are lost! <i><b>You don't have to leave python at all!</b></i>  
							Instead, when you're in python, paste or type (only once!) <pre>&gt;&gt;&gt; execfile( 'hw3pr1.py' )</pre> This completely reloads the file named
							<tt>hw3pr1.py</tt>. Then, you can use up-arrow to return to previous commands. Also, when you need to change your file to fix a bug or add a function, 
							you can simply up-arrow back to <tt>execfile( 'hw3pr1.py' )</tt> and hit enter! No need to leave Python at all -- this will typically save lots of time 
							(and frustration)!
						</div>
					</div>
				</div>
