							...
							<p>
							  	...
							  	<ul>
									...
									<li> On Windows: <tt>python</tt>  
										<ul>
											<li> If you've installed Python and it can't find it (usually Windows 10), <a class="twikiLink" href="https://www.cs.hmc.edu/twiki/bin/view/CS5Fall2015/AddPythonToPath">this page explains how to add Anaconda's Python to your path</a></li>
										</ul> 
									</li>
								</ul> 
					...
					<div id="collapseEight" class="collapse" role="tabpanel" aria-labelledby="headingEight">
						<div class="card-block">
							...
							<p>
								...
								If you'd like to continue on to do that, <a href="homeworks/homework0.php" target="_blank">head to hw0 problem 2</a> 
							</p>
							<p>
							...
							<p>
								If everything has worked smoothly (at least eventually!) you're finished with Lab 0!  Each week, if you work on the lab through the lab time, even 
								if you don't complete the lab, you will receive full credit for the lab's problem(s). The sign-in sheet is how we make sure of this.  If you're 
								finished early, you're welcome to head off to other things, if you'd like.
							</p>
							<p>
								Or, if you're in a groove, you're welcome to continue to the next problem(s) on the week's hw: 
								<ul>
									<li><a href="homeworks/homework0.php">Homework0</a> hw0pr2 is rock-paper-scissors</li>
